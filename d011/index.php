...
<body>
    ...
    <section>
        ...
        <p>O produto custava R$<?=number_format($preco,2,",",".")?> com <strong><?=number_format($reaj, 0,",",".")?>% de
                aumento</strong> vai passar a custar <strong> R$<?=number_format($novopreco,2,",",".")?></strong> a
            partir de agora</p>
    </section>
    <script>
    mudaValor();
